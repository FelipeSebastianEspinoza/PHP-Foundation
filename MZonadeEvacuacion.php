    ...
    <div class="off-canvas-content" data-off-canvas-content>
        <div class="grid-x grid-padding-x">
            ...
            <div class="row column">
                <hr>
                <h4 style="margin: 0;" class="text-center">Modificar Zona de Evacuación</h4>
                <hr>
            </div>
            <div class="callout">
...
if(isset($_POST['submitmodificargrifo'])){
    ...
    $campos = array("id_zonadeevacuacion"=> $_POST['id_zonadeevacuacion'] ,
	"nombre"=>$_POST['nombre'],
	"descripcion"=>$_POST['descripcion'],
	"imagen"=>$_POST['ARCHIVO']); 
 
    $nuevo = new ZonadeEvacuacion("tesis"); 
