...
?>	
 <table>
  <thead>
	...
	<?php  
	  echo'<form class="formulario" action="MHistorialMutual.php" method="post" id="usrform" enctype="multipart/form-data">';
...
<div id="nuevoprotocolo">
  ...
  <tbody>  
	...
	<td><input type="text" id="inputEstado" name="estado" class="form-control" placeholder=" "   ></td>
...
if(isset($_POST['submitprotocolo'])){
    ...
    $nuevo->NuevoArchivoMutual($campos);
}
