    ...
    <div class="off-canvas-content" data-off-canvas-content>
        <div class="grid-x grid-padding-x">
            ...
            <div class="row column">
                <hr>
                <h4 style="margin: 0;" class="text-center">Zona de Evacuación</h4>
                <hr>
            </div>
            <div class="callout">
...
<insertar>
 	<a class="success button"href="ZonadeEvacuacion.php">Añadir Zona de Evacuación</a>		 
  <table>
  <thead>
    <tr>
  ...
  <?php  
			...
			$result = mysqli_query($conn, 'SELECT *
									  	   FROM zonadeevacuacion
										   WHERE eliminar!="1";');
 							   
		    while($row = mysqli_fetch_array($result)){
  
 echo'<form action="MZonadeEvacuacion.php" method="post">';	 
 echo '<input type="hidden" name="id_zonadeevacuacion" value='.$row["id_zonadeevacuacion"].' />'; 
      echo '<tr>';
